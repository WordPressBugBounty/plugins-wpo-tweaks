...
// Plugin constants.
define( 'CORE_DIET_VERSION', '3.7.0' );
 ...
 *
 * Ported from the former wpo-tweaks codebase. DietPress itself stopped using it
 * in 3.6.0, with the exception for Internet Explorer 9; it stays for code that
 * calls it.
 *
 * @return string
 */
